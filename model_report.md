...
| Las Vegas | 3.0 (-3.0) n=13 | - | - | - | - |
| Los Angeles | 3.4 (+3.4) n=10 | - | - | - | - |
...
| Phoenix | 1.3 (-1.0) n=11 | - | - | - | - |
| San Antonio | 1.0 (-0.5) n=14 | 1.2 (+1.2) n=1 | 0.8 (-0.8) n=1 | 1.3 (+1.3) n=1 | 0.5 (+0.5) n=1 |
| San Francisco | 3.9 (+3.3) n=11 | - | - | - | - |
| Seattle | 2.9 (-1.8) n=12 | - | - | - | - |
| Washington DC | 1.5 (-1.3) n=13 | 2.5 (-2.5) n=1 | 0.2 (+0.2) n=1 | 5.1 (-5.1) n=1 | 2.5 (-2.5) n=1 |

## Overall (all cities pooled)

- **icon**: median miss 1.45F, lean -1.45F, n=12
- **nws**: median miss 1.50F, lean -0.50F, n=12
- **pool**: median miss 1.60F, lean -0.70F, n=247
- **gfs**: median miss 2.05F, lean -0.20F, n=12
- **ecmwf**: median miss 2.35F, lean -1.85F, n=12
